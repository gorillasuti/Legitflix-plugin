...
class JellyfinService {
    ...
    getStreamUrl(itemId, audioStreamIndex = null, subtitleStreamIndex = null, mediaSourceId = null, maxBitrate = null) {
        ...
        let url = `${baseUrl}/Videos/${itemId}/master.m3u8?PlaySessionId=LegitFlix-${Date.now()}&api_key=${token}&DeviceId=${deviceId}&VideoCodec=h264,hevc,vp9,av1&AudioCodec=aac,mp3&TranscodingContainer=ts&TranscodingProtocol=hls`;
